...
-- Trial Management System Database Tables
...
-- Add trial_manager_id to trial_players table
...
-- Update trial_payments table for better tracking
ALTER TABLE `trial_payments` 
ADD COLUMN IF NOT EXISTS `trial_manager_id` int(11) DEFAULT NULL AFTER `trial_player_id`,
ADD COLUMN IF NOT EXISTS `remaining_amount` decimal(10,2) DEFAULT 0.00 AFTER `amount`,
ADD INDEX IF NOT EXISTS `idx_trial_manager_payment` (`trial_manager_id`);
