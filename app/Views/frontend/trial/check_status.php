...
<head>
    ...
    <title>Check Trial Status - MPCL</title>
    ...
    <style>
        ...
        * {
        ...
        .alert-success.alert-modern .alert-title {
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10">
                <div class="card status-card">
                    <div class="card-header">
                        ...
                        <h2>Trial Status Check</h2>
                        <p class="subtitle">Enter your mobile number to check trial status and grade</p>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="search-section">
                            <form method="POST" action="<?= base_url('trial-status-check') ?>" id="statusForm">
                                <?= csrf_field() ?>
                        ...
                        <div class="info-section">
                            ...
                            <div class="feature-list">
                                <div class="feature-item">
                                    ...
                                    <h5>Trial Status</h5>
                                    <p>Check if your trial registration is complete</p>
                                </div>
                                <div class="feature-item">
                                ...
                                <div class="feature-item">
                                    ...
                                    <p>See your assigned grade and trial details</p>
                                </div>
                            </div>
                        </div>

                        <div class="text-center mt-4">
                            <p class="text-muted mb-3">Haven't registered yet?</p>
                            <a href="<?= base_url('trial-registration') ?>" class="btn btn-outline-golden">
                                <i class="fas fa-plus me-2"></i>Register for Trial
                            </a>
                        </div>
                    </div>
                </div>
